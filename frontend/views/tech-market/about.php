    ...
    <div class="col-full">
        <div class="row">
            <nav class="woocommerce-breadcrumb">
                <a href="/tech-market/index">Home</a>
                    ...
                    <div class="type-page hentry">
                        <header class="entry-header">
                            <div class="page-featured-image">
                                <img width="1920" height="1391" alt="" class="attachment-full size-full wp-post-image" src="/images/products/about-header.jpg">
                            </div>
                            <!-- .page-featured-image -->
                            ...
                            <div class="about-features row">
                                <div class="col-md-4">
                                    <div class="single-image">
                                        <img alt="" class="" src="/images/products/3column1.jpg">
                                    </div>
                                    <!-- .single_image -->
                                ...
                                <div class="col-md-4">
                                    <div class="single-image">
                                        <img alt="" class="" src="/images/products/3column2.jpg">
                                    </div>
                                    <!-- .single_image -->
                                    <div class="text-block">
                            ...
                            <div class="light-bg team-member-wrapper">
                                <div class="col-full">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="team-member circle">
                                                <img src="/images/team-member/7.png" alt="">
                                                <div class="profile">
                                                    <h3>See Details
