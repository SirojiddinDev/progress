            ...
            <div class="top-bar top-bar-v1">
                <div class="col-full">
                    <ul id="menu-top-bar-left" class="nav justify-content-center">
                        ...
                        <li class="menu-item animate-dropdown">
                            <a title="Quality Guarantee of products" href="../shop/shop.php">Quality Guarantee of products</a>
                        </li>
                        <li class="menu-item animate-dropdown">
                ...
                <div class="col-full">
                    <div class="row">
                        <nav class="woocommerce-breadcrumb">
                            ...
                            </span><a href="product-category.html">Home Entertainment</a>
                            <span class="delimiter">
                                <i class="tm tm-breadcrumbs-arrow-right"></i>
                            </span><a href="product-category.html">TVs</a>
                            <span class="delimiter">
                                <i class="tm tm-breadcrumbs-arrow-right"></i>
