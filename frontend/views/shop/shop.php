                ...
                <div class="col-full desktop-only">
                        ...
                        <div class="row">
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                        <a title="Super deals" href="../site/product-category.html">Super deals</a>
                                    </li>
                                    <li class="menu-item menu-item-has-children animate-dropdown dropdown">
                                        ...
                                        <ul role="menu" class=" dropdown-menu">
                                            <li class="menu-item animate-dropdown">
                                                <a title="Wishlist" href="../site/wishlist.html">Wishlist</a>
                                            </li>
                                            <li class="menu-item animate-dropdown">
                                                <a title="Add to compare" href="../site/compare.html">Add to compare</a>
                                            </li>
                                            <li class="menu-item animate-dropdown">
                                                <a title="About Us" href="../site/about.html">About Us</a>
                                            </li>
                                            <li class="menu-item animate-dropdown">
                                    ...
                                    <li class="menu-item animate-dropdown">
                                        <a title="Logitech Sale" href="../site/product-category.html">Logitech Sale</a>
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                        <a title="Headphones Sale" href="../site/product-category.html">Headphones Sale</a>
                                    </li>
                            ...
                            <nav id="secondary-navigation" class="secondary-navigation" aria-label="Secondary Navigation" data-nav="flex-menu">
                                <ul id="menu-secondary-menu" class="nav">
                                    ...
                                    <li class="menu-item">
                                        <a title="My Account" href="../site/login-and-register.html">
                    ...
                    <div class="row align-items-center">
                        ...
                        <ul class="header-compare nav navbar-nav">
                            <li class="nav-item">
                                <a href="../site/compare.html" class="nav-link">
                        ...
                        <ul class="header-wishlist nav navbar-nav">
                            <li class="nav-item">
                                <a href="../site/wishlist.html" class="nav-link">
                        ...
                        <ul id="site-header-cart" class="site-header-cart menu">
                            <li class="animate-dropdown dropdown ">
                                <a class="cart-contents" href="../site/cart.html" data-toggle="dropdown" title="View your shopping cart">
                                            ...
                                            <div class="widget_shopping_cart_content">
                                                <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                                    <li class="woocommerce-mini-cart-item mini_cart_item">
                                                        ...
                                                        <a href="../site/single-product-sidebar.html">
                                                ...
                                                <p class="woocommerce-mini-cart__buttons buttons">
                                                    <a href="../site/cart.html" class="button wc-forward">View cart</a>
                                                    <a href="../site/checkout.html" class="button checkout wc-forward">Checkout</a>
                                                </p>
                                            </div>
                    ...
                    <div class="handheld-header">
                        <div class="row">
                            ...
                            <div class="handheld-header-links">
                                <ul class="columns-3">
                                    <li class="my-account">
                                        <a href="../site/login-and-register.html" class="has-icon">
                                            <i class="tm tm-login-register"></i>
                                        </a>
                                    </li>
                                    <li class="wishlist">
                                        <a href="../site/wishlist.html" class="has-icon">
                                            <i class="tm tm-favorites"></i>
                                            <span class="count">3</span>
                                        </a>
                                    </li>
                                    <li class="compare">
                                        <a href="../site/compare.html" class="has-icon">
                                            <i class="tm tm-compare"></i>
                                            <span class="count">3</span>
                                        </a>
                                    </li>
                        ...
                        <div class="techmarket-sticky-wrap">
                            <div class="row">
                                ...
                                <!-- .site-search -->
                                <a class="handheld-header-cart-link has-icon" href="../site/cart.html" title="View your shopping cart">
                                    <i class="tm tm-shopping-bag"></i>
                                    <span class="count">2</span>
                                </a>
                            </div>
                                            ...
                                            <div class="products">
                                                <div class="product first">
                                                    <div class="yith-wcwl-add-to-wishlist">
                                                        <a href="../site/wishlist.html" rel="nofollow" class="add_to_wishlist"> Add to Wishlist</a>
                                                    </div>
                                                    <!-- .yith-wcwl-add-to-wishlist -->
                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="../site/single-product-fullwidth.html">
                                                    ...
                                                    <div class="hover-area">
                                                        <a class="button" href="../site/cart.html">Add to cart</a>
                                                        <a class="add-to-compare-link" href="../site/compare.html">Add to compare</a>
                                                    </div>
                                                    <!-- .hover-area -->
                                                </div>
                                                <!-- .product -->
                                        ...
                                        <div class="woocommerce columns-5">
                                            <div class="products">
                                                <div class="product first">
                                                    ...
                                                    <a class="button product_type_simple add_to_cart_button" href="../site/cart.html">Add to cart</a>
                                                    <a class="add-to-compare-link" href="../site/compare.html">Add to compare</a>
                                                </div>
                                                <!-- .product -->
                                                <div class="product ">
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <div class="product-actions">
                                                                ...
                                                                <!-- .price -->
                                                                <a class="button add_to_cart_button" href="../site/cart.html">Add to Cart</a>
                                                                <a class="add-to-compare-link" href="../site/compare.html">Add to compare</a>
                                                            </div>
                                                            <!-- .product-actions -->
                                                        </div>
                            ...
                            <div class="widget woocommerce widget_product_categories techmarket_widget_product_categories" id="techmarket_product_categories_widget-2">
                                <ul class="product-categories ">
                                    <li class="product_cat">
                                        ...
                                        <ul>
                                            <li class="cat-item">
                                                <a href="../site/product-category.html">
                                            ...
                                            <div class="woocommerce columns-1">
                                                <div class="products">
                                                    <div class="landscape-product-widget product">
                                                        <a class="woocommerce-LoopProduct-link" href="../site/single-product-fullwidth.html">
                                                            <div class="media">
                                        ...
                                        <div class="body">
                                            ...
                                            <div class="menu-footer-menu-3-container">
                                                <ul id="menu-footer-menu-3" class="menu">
                                                    <li class="menu-item">
                                                        <a href="../site/login-and-register.html">My Account</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="track-your-order.html">Track Order</a>
                                                    </li>
                                                    ...
                                                    <li class="menu-item">
                                                        <a href="../site/wishlist.html">Wishlist</a>
                                                    </li>
                                                    <li class="menu-item">
