                                            ...
                                            <div class="tm-mega-menu">
                                                ...
                                                <div class="widget widget_nav_menu">
                                                    <ul class="menu">
                                                        ...
                                                        <li class="menu-item">
                                                            <a href="../shop/shop_extended">Shop Extended</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a href="/shop/shop_listing">Shop Listing</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a href="shop/shop_listing_large">Shop Listing Large</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a href="/shop/shop_listing_with_product_sidebar">Shop Listing with Product Sidebar</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a href="/product/product_category">Categories</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a href="/shop/shop_right_sidebar">Shop Right Sidebar</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a href="/shop/shop_fullwidth">Shop Full Width</a>
                                                        </li>
                                                    </ul>
                                                    <!-- .menu -->
                                                </div>
                                                ...
                                                <div class="widget widget_nav_menu">
                                                    <ul class="menu">
                                                        ...
                                                        <li class="menu-item menu-item-object-product">
                                                            <a href="/single/single_product_sidebar">Single Product Sidebar</a>
                                                        </li>
                                                        <li class="menu-item menu-item-object-product">
                                                            <a href="/single/single_product_fullwidth">Single Product Fullwidth</a>
                                                        </li>
                                                        <li class="menu-item menu-item-object-product">
                                                            <a href="/single/single_product_extended">Single Product Extended</a>
                                                        </li>
                                                        <li class="nav-title menu-item">
                                                        ...
                                                        <li class="menu-item">
                                                            <a href="/site/login_and_register">My Account</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a href="/site/compare">Compare</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a href="/site/wishlist">Wishlist</a>
                                                        </li>
                                                        <li class="menu-item">
                            ...
                            <div class="handheld-navigation-menu">
                                ...
                                <ul id="menu-departments-menu-1" class="nav">
                                    <li class="highlight menu-item animate-dropdown">
                                        <a title="Value of the Day" href="../shop/shop.php">Value of the Day</a>
                                    </li>
                                    <li class="highlight menu-item animate-dropdown">
                                        <a title="Top 100 Offers" href="../shop/shop.php">Top 100 Offers</a>
                                    </li>
                                    <li class="highlight menu-item animate-dropdown">
                                        <a title="New Arrivals" href="../shop/shop.php">New Arrivals</a>
                                    </li>
                                                            ...
                                                            <div class="kc-col-container">
                                                                <div class="kc_text_block">
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="../shop/shop.php">All Computers &amp; Accessories</a></li>
                                                                        <li><a href="../shop/shop.php">Laptops, Desktops &amp; Monitors</a></li>
                                                                        <li><a href="../shop/shop.php">Pen Drives, Hard Drives &amp; Memory Cards</a></li>
                                                                        <li><a href="../shop/shop.php">Printers &amp; Ink</a></li>
                                                                        <li><a href="../shop/shop.php">Networking &amp; Internet Devices</a></li>
                                                                        <li><a href="../shop/shop.php">Computer Accessories</a></li>
                                                                        <li><a href="../shop/shop.php">Software</a></li>
                                                            ...
                                                            <div class="kc-col-container">
                                                                <div class="kc_text_block">
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="../shop/shop.php">All Office &amp; Stationery</a></li>
                                                                        <li><a href="../shop/shop.php">Pens &amp; Writing</a></li>
                                                                    </ul>
                                                                </div>
                                                                <!-- .kc_text_block -->
                                                            </div>
                                                            ...
                                                            <div class="kc-col-container">
                                                                <div class="kc_text_block">
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="../shop/shop.php">All Cameras & Photography</a></li>
                                                                        <li><a href="../shop/shop.php">Point & Shoot Cameras</a></li>
                                                                        <li><a href="../shop/shop.php">Lenses</a></li>
                                                                        <li><a href="../shop/shop.php">Camera Accessories</a></li>
                                                                        <li><a href="../shop/shop.php">Security & Surveillance</a></li>
                                                                        <li><a href="../shop/shop.php">Binoculars & Telescopes</a></li>
                                                                        <li><a href="../shop/shop.php">Camcorders</a></li>
                                                                        <li class="nav-divider"></li>
                                                                        <li>
                                                                            <a href="#">
                                                                                <span class="nav-text">All Electronics</span>
                                                            ...
                                                            <div class="kc-col-container">
                                                                <div class="kc_text_block">
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="../shop/shop.php">All Audio & Video</a></li>
                                                                        <li><a href="../shop/shop.php">Headphones & Speakers</a></li>
                                                                        <li><a href="../shop/shop.php">Home Entertainment Systems</a></li>
                                                                        <li><a href="../shop/shop.php">MP3 & Media Players</a></li>
                                                                    </ul>
                                                                </div>
                                                                <!-- .kc_text_block -->
                                                            </div>
                                    ...
                                    <li class="menu-item animate-dropdown">
                                        <a title="Gadgets" href="../shop/shop.php">Gadgets</a>
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                        <a title="Virtual Reality" href="../shop/shop.php">Virtual Reality</a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div id="primary" class="content-area">
                    <main id="main" class="site-main">
                        <div class="home-v10-slider home-slider">
                            <div class="slider-1" style="background-image: url(images/slider/home-v10-background.jpg);">
                                <img src="images/slider/home-v10-img-1.png" alt="">
                                <div class="caption">
                            ...
                            <div class="row">
                                <div class="banner large-banner text-in-center">
                                    <a href="../shop/shop.php">
                                        <div style="background-size: cover; background-position: center center; background-image: url( images/banner/10-1.jpg ); height: 546px;" class="banner-bg">
                                            <div class="caption">
                                ...
                                <div class="banner small-banner text-in-center">
                                    <a href="../shop/shop.php">
                                        <div style="background-size: cover; background-position: center center; background-image: url( images/banner/10-2.jpg ); height: 262px;" class="banner-bg">
                                            <div class="caption">
                                                <div class="banner-info">
                                ...
                                <div class="banner small-banner text-in-center">
                                    <a href="../shop/shop.php">
                                        <div style="background-size: cover; background-position: center center; background-image: url( images/banner/10-3.jpg ); height: 262px;" class="banner-bg">
                                            <div class="caption">
                                                <div class="banner-info">
                                ...
                                <div class="banner large-banner text-in-center">
                                    <a href="../shop/shop.php">
                                        <div style="background-size: cover; background-position: center center; background-image: url( images/banner/10-4.jpg ); height: 546px;" class="banner-bg">
                                            <div class="caption">
                                                <div class="banner-info">
                                                    ...
                                                    <div class="products">
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/2.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                                                                ...
                                                                <!-- /.price -->
                                                                <h2 class="woocommerce-loop-product__title">Converse</h2>
                                                            </a>
                                                        ...
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/7.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                                                                                <span class="amount"> </span>
                                                                            </ins>
                                                        ...
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/5.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                                                                                <span class="amount"> </span>
                                                                            </ins>
                                                                ...
                                                                <!-- /.price -->
                                                                <h2 class="woocommerce-loop-product__title">Nike Air Max Woven Boot</h2>
                                                            </a>
                                                            <div class="techmarket-product-rating">
                                                                <div class="star-rating" title="Rated 0 out of 5">
                                                                            <span style="width:0%">
                                                        ...
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/4.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                                                                                <span class="amount"> </span>
                                                                            </ins>
                                                                ...
                                                                <!-- /.price -->
                                                                <h2 class="woocommerce-loop-product__title">Nike Air Force</h2>
                                                            </a>
                                                            <div class="techmarket-product-rating">
                                                                <div class="star-rating" title="Rated 0 out of 5">
                                                                            <span style="width:0%">
                                                        ...
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/6.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                                                        ...
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/3.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                                                                                <span class="amount"> </span>
                                                                            </ins>
                                                                ...
                                                                <!-- /.price -->
                                                                <h2 class="woocommerce-loop-product__title">Nike Air Max Plus TN ULTRA</h2>
                                                            </a>
                                                            <div class="techmarket-product-rating">
                                                                <div class="star-rating" title="Rated 0 out of 5">
                                                                            <span style="width:0%">
                                                        ...
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/1.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                        ...
                        <div class="home-v10-banner-with-products-carousel row stretch-full-width">
                            <div class="banner column-1">
                                <a href="../shop/shop.php">
                                    <div style="background-size: cover; background-position: center center; background-image: url( images/banner/10-5.jpg ); height: 724px;" class="banner-bg">
                                        <div class="caption">
                                            <div class="banner-info">
                                                <h3 class="title">
                        ...
                        <section class="section-products-carousel-tabs techmarket-tabs">
                            <div class="section-products-carousel-tabs-wrap">
                                ...
                                <div class="tab-content">
                                            ...
                                            <div class="container-fluid">
                                                <div class="woocommerce columns-7">
                                                    <div class="products">
                                                        ...
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/8.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                                                                                <span class="amount"> </span>
                                                                            </ins>
                                                        ...
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/10.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                                                                                <span class="amount"> </span>
                                                                            </ins>
                                                        ...
                                                        <div class="product">
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="images/shoes/9.jpg" class="wp-post-image" alt="">
                                                                <span class="price">
                                                                            <ins>
                                                                                <span class="amount"> </span>
                                                                            </ins>
                                                                ...
                                                                <!-- /.price -->
                                                                <h2 class="woocommerce-loop-product__title">Nike Air Max Jewell</h2>
                                                            </a>
                                                            <div class="hover-area">
                                                                <a class="button add_to_cart_button" href="cart.html" rel="nofollow">Add to cart</a>
                                                                <a class="add-to-compare-link" href="compare.html">Compare</a>
                                    ...
                                    <!-- .tab-pane -->
                                    <div id="tab-59f89f0ad18d71" class="tab-pane " role="tabpanel">
                                        <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;rows&quot;:2,&quot;slidesPerRow&quot;:7,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:766,&quot;settings&quot;:{&quot;slidesPerRow&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesPerRow&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesPerRow&quot;:4}},{&quot;breakpoint&quot;:1700,&quot;settings&quot;:{&quot;slidesPerRow&quot;:5}}]}">
                                            <div class="container-fluid">
                                                <div class="woocommerce columns-5">
                                                    <div class="products">
                                    ...
                                    <!-- .tab-pane -->
                                    <div id="tab-59f89f0ad18d73" class="tab-pane " role="tabpanel">
                                        <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;rows&quot;:2,&quot;slidesPerRow&quot;:7,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:766,&quot;settings&quot;:{&quot;slidesPerRow&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesPerRow&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesPerRow&quot;:4}},{&quot;breakpoint&quot;:1700,&quot;settings&quot;:{&quot;slidesPerRow&quot;:5}}]}">
                                            <div class="container-fluid">
                                                <div class="woocommerce columns-5">
                                                    <div class="products">
                        ...
                        <div class="banners techmarket-banner techmarket-grid-banner-2">
                            <div class="row">
                                <div class="banner large-banner text-in-center">
                                    <a href="../shop/shop.php">
                                        <div style="background-size: cover; background-position: center center; background-image: url( images/banner/10-6.jpg ); height: 539px;" class="banner-bg">
                                            <div class="caption">
                                                <div class="banner-info">
                                ...
                                <div class="banner small-banner text-in-center">
                                    <a href="../shop/shop.php">
                                        <div style="background-size: cover; background-position: center center; background-image: url( images/banner/10-7.jpg ); height: 273px;" class="banner-bg">
                                            <div class="caption">
                                                <div class="banner-info">
                                                    <h3 class="title">&nbsp;</h3>
                                                </div>
                                ...
                                <div class="banner small-banner text-in-center">
                                    <a href="../shop/shop.php">
                                        <div style="background-size: cover; background-position: center center; background-image: url( images/banner/10-8.jpg ); height: 273px;" class="banner-bg">
                                            <div class="caption">
                                                <div class="banner-info">
                                                    <h3 class="title">&nbsp;</h3>
                                                </div>
                                ...
                                <div class="banner large-banner text-in-center">
                                    <a href="../shop/shop.php">
                                        <div style="background-size: cover; background-position: center center; background-image: url( images/banner/10-9.jpg ); height: 544px;" class="banner-bg">
                                            <div class="caption">
                                                <div class="banner-info">
                                                    <h3 class="title">&nbsp;</h3>
                                                </div>
                                ...
                                <div class="body">
                                    ...
                                    <div class="menu-footer-menu-1-container">
                                        <ul id="menu-footer-menu-1" class="menu">
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Computers &#038; Laptops</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Cameras &#038; Photography</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Smart Phones &#038; Tablets</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Video Games &#038; Consoles</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">TV</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Car Electronic &#038; GPS</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="body">
                                    ...
                                    <div class="menu-footer-menu-2-container">
                                        <ul id="menu-footer-menu-2" class="menu">
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Printers &#038; Ink</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Audio &amp; Music</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Home Theaters</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">PC Components</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Ultrabooks</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="../shop/shop.php">Smartwatches</a>
                                            </li>
                                        </ul>
                                    </div>
